...
Usage:
    ...
    >>> 
    >>> # Modbus RTU
    >>> from vyra_base.com.external.modbus.rtu import ModbusRTUClient
    >>> 
...
try:
    from vyra_base.com.external.modbus.base import (
        ModbusBaseClient,
...
# Try importing TCP
try:
    from vyra_base.com.external.modbus.tcp import (
        ModbusTCPClient,
...
# Try importing RTU
try:
    from vyra_base.com.external.modbus.rtu import (
        ModbusRTUClient,
