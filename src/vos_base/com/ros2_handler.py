...
from vos_base.com.communication_handler import CommunicationHandler
...
class ROS2Handler(CommunicationHandler):
    ...
    def __init__(self, publisher: VOSPublisher, type: Any):
        self._publisher: VOSPublisher = publisher
        self._type: Any = type
        super().__init__()
